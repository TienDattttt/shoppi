...
export function PartnerChatList() {
        ...
        <div className="flex flex-col h-full bg-white border-r w-1/3 min-w-[200px]">
            ...
            <div className="p-3 border-b">
                <div className="relative">
                    ...
                    <Input className="h-8 pl-7 text-xs bg-gray-50 border-none" placeholder="Tìm kiếm khách hàng" />
                </div>
            </div>
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0 flex flex-col justify-center">
                                <div className="flex justify-between items-center mb-0.5">
                                    <span className={cn("font-medium text-sm truncate pr-2", activeConversationId === conv.id ? "text-blue-600" : "text-gray-900")}>
                                        {conv.recipientName}
                                    </span>
